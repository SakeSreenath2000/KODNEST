package com.kodnest.JDBC_Hospital_Project.Programming;
//Importing java.sql package
import java.sql.*;
import java.util.Scanner;

public class HosJDBC {
	public static void main(String[] args) {
		...
		try {
			...
			for(int i=1;i<=rows;i++)
			{
				...
				pstmt.execute();
				System.out.println("Row "+i+" data is Inserted");
				
			}
			System.out.println(rows + "Rows of data is Inserted");
		}
		catch(Exception e){
			e.printStackTrace();
		}
