...
public class StudentApp {
	public static void main(String[] args) {
		...
		// (or)
		/*StudentWithoutUsingDownCasting st1=new StudentWithoutUsingDownCasting(2,"Ajay",98.45F);
		  StudentWithoutUsingDownCasting st2=new StudentWithoutUsingDownCasting(1,"Amit",88.23F);
		  StudentWithoutUsingDownCasting st3=new StudentWithoutUsingDownCasting(3,"Anuj",99.56F);*/
		// creating ArrayList
		...
		// sort() internally calls the compareTo() present in the student class
		// compareTo() is written for sorting the elements
